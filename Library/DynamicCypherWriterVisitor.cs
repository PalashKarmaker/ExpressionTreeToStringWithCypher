...
public class DynamicCypherWriterVisitor(Dictionary<string, string> cypherPropertyMap, object o, OneOf<string, Language?> languageArg) :
    DynamicLinqWriterVisitor(o, languageArg, false) {
