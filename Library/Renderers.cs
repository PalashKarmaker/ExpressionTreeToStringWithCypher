...
public delegate (string result, Dictionary<string, (int start, int length)>? pathSpans) CypherRenderer(object o, OneOf<string, Language?> languageArg, bool usePathSpans);
